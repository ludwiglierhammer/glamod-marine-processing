...
# Find file specific parameters in job_index.input file located in the level1b
...
to_remove_file=$code_directory/configuration_files/r092019_000000_level1c_remove.txt
ddata=$data_directory/r092019/ICOADS_R3.0.0T/level1c
dlog=$data_directory/r092019/ICOADS_R3.0.0T/level1c/log
dql=$data_directory/r092019/ICOADS_R3.0.0T/level1c/quicklooks
