...
echo "Launching line:"
echo "python $scripts_directory/L1e_maps_repeat_buoys_cdmlite.py $data_directory $sid_deck $yr $mo $release $update $source"

python $scripts_directory/L1e_maps_repeat_buoys_cdmlite.py $data_directory $sid_deck $yr $mo $release $update $source
