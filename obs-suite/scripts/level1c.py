...
id_validation_path = os.path.join(params.data_path,params.release,'NOC_ANC_INFO','json_files')# os.path.join(params.data_path,'datasets',params.dataset,'NOC_ANC_INFO','json_files')
