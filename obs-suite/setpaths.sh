...
export config_directory=$home_directory_smf/code/marine_code/glamod-marine-config/obs-suite/configuration_files/release_5.0_000000/ICOADS_R3.0.2T_NRT
...
export data_directory=/gws/nopw/j04/c3s311a_lot2/data/marine/
