...
def from_cdm_monthly(year, month, dir_data = None, db_con = None, 
                     cdm_id = None, table = None, element = None,
                     aggregation = None, filter_by_values = None, 
    ...
    dir_data : str, optional
        The path to the CDM table file(s)
    ...
    if dir_data:
        kwargs = {'dir_data' : dir_data, 'db_con' : db_con, 
                    'cdm_id' : cdm_id,'element' : element, 
