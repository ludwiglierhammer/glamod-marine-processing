...
pyEnvironment_directory=$home_directory_smf/code/marine_code/glamod-marine-processing/obs-suite/pyenvs/env2
...
export PYTHONPATH="$pyTools_directory:$um_code_directory:${PYTHONPATH}"
