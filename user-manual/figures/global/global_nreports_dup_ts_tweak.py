...
#    file_out = config['file_out']
    ...
    file_data='/Users/iregou/C3S/marine-user-guide/v4/duplicate_status_ts_global.psv'
    file_out='/Users/iregou/C3S/marine-user-guide/v4/global_duplicate_status_ts_tweak.pdf'
    ...
    ax.stackplot(data.index,100*data['0']/data['nreports'],
        ...
        100*data['2']/data['nreports'] + 100*data['3']/data['nreports'],
        labels = ['unique','best','not checked','duplicates'], colors=['Grey','DarkCyan','SeaShell','Red'],alpha = 0.3,edgecolor=['Grey']*5,linewidth=.3)
