...
pattern = {
    ...
    "level1b": "header-icoads_r???_d???_????-??-??_subset.parquet",
    "level1c": "header-icoads_r???_d???_????-??-??_subset.parquet",
    "level1d": "header-icoads_r???_d???_????-??-??_subset.parquet",
    "level1e": "header-icoads_r???_d???_????-??-??_subset.parquet",
    "level2": "header-icoads_r???_d???_????-??-??_subset.parquet",
    "level3": "header-icoads_r???_d???_????-??-??_subset.parquet",
}
pattern_out = {"level3": "insitu-surface-marine_2022-01.parquet"}
