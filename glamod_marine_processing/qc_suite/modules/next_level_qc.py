...
def do_position_check(latitude, longitude):
        ...
        self.set_qc(
            "POS", "pos", qc.position_check(latitude, longitude)
        )
...
def perform_base_qc(pt, latitude, longitude, timestamp, parameters):
    ...
    is_day = do_day_check(parameters["base"]["time_since_sun_above_horizon"])  # maybe we need this variable afterwards
    
    
def perform_obs_qc(at=None, dpt=None, slp=None, sst=None, wbt=None, wd=None, ws=None, parameters={}):
