    ...
    for country in countries:
        ...
        for job in control["jobs"]:
            ...
            input_file = (
                outputpath
                + "./split/"
                + os.path.basename(job["data_file"])
                + "."
                + country
            )
            ...
            if master.shape[0] > 0:
                ...
                for idx in tmpDf.index.values:
                    ...
                    if matches.shape[0] > 0:
                        ...
                        id_match = matches[
                            matches["record_number"] == max_record
                        ].index.values
                        ...
                        if distance > 0.8:
                            ...
                            common = list(
                                ...
                                .intersection(config["duplicateChecks"])
                            )
                            ...
                            if (
                                ...
                                if missing.all():
                                    ...
                                    if len(right_columns) > 0:
                                        master.at[
                                            id_match[0], right_columns
                                        ] = tmpDf.loc[idx, right_columns]
                                else:
                                    ...
                                    if len(numeric_mismatch) > 0:
                                        ...
                                        print(
                                            tmpDf.loc[
                                                idx, pd.np.array(common)[mismatch]
                                            ]
                                        )
                                        print(
                                            matches.loc[
            ...
            master = pd.concat(
                [master, tmpDf.loc[to_add,]], ignore_index=True, sort=False
            )
        ...
        uid = master.apply(
            lambda x: "{}-{}-{}".format(
                x["callsign"], x["sx"], x["recruiting_country"]
            ),
            axis=1,
        )
