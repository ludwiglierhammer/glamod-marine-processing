"""Metadata suite splitting PUB47 data module."""
...
from pub47 import (
    ...
    imiss,
    pub47_merge_rows,
    pub47_record_compare,
    pub47_record_completeness,
    pub47load,
    pub47schema,
)
...
def read_args(argv):
    ...
    parser.add_argument(
        ...
        required=True,
        default="jobs.json",
        help="JSON file containing list of jobs to run",
    )
    parser.add_argument(
        "-start",
        dest="jobIndexStart",
...
def main(argv):
    ...
    for job_index in np.arange(first_job, last_job + 1, 1):
        ...
        rejects.to_csv(
            outputpath + "./split/" + os.path.basename(input_file) + "." + "reject",
            index=False,
            sep="|",
            na_rep="NULL",
        )
