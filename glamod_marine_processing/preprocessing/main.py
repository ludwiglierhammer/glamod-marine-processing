"""GLAMOD marine data processing pre-precessing module."""
...
def main(argv):
    ...
    for pathIdx in range(npaths):
        ...
        infiles = sorted(
            glob.glob("{}/IMMA1_R3.0.*".format(config["data-path"][pathIdx]))
        )
        # get number of files
        nfiles = len(infiles)
