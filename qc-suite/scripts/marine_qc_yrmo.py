...
marine_qc.py invoked by typing::
  ...
  python3 marine_qc_yrmo.py -config configuration.txt -year1 1850 -year2 1855 -month1 1 -month2 1 [-tracking]
...
def main(argv):
    ...
    parser.add_argument('-year1', type=int, help='input start year')
    parser.add_argument('-year2', type=int, help='input end year')
    parser.add_argument('-month1', type=int, help='input start month')
    parser.add_argument('-month2', type=int, help='input end month')
    ...
    for year, month in qc.year_month_gen(year1, month1, year2, month2):
        ...
        for readyear, readmonth in qc.year_month_gen(year, month, next_year, next_month):
